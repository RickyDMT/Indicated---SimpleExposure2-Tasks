...
%         SimpExpFood.data(tcounter).rate_onset = rateon - scan_sec;
...
%                 SimpExpFood.data(tcounter).rate_RT = rt - rateon;
%                 
...
%                 end
% 
%                 SimpExpFood.data(tcounter).rating = rating;
%                 break;
%             end
%         end        
    end
...
savename_csv = [savedir filesep sprintf('SimpExp_Food_%d-%d.csv',ID,SESS)];
